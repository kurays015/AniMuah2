...
const URL = `${base_url}/top/anime?filter=airing&page=1&limit=25`
...
const getOngoingAnime = async (page) => {
...
//upcoming animes
function renderOngoingAnime(data) {
